	...
	public function enqueue_assets( $hook ) {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					'buildingSingle'    => __( 'Building your export ZIP — this can take a while for large libraries…', 'ekwa-wsei' ),
					'buildingBatch'     => __( 'Building batch %1$d of %2$d…', 'ekwa-wsei' ),
					'doneSingle'        => __( 'Done — your export ZIP was built and downloaded. If the download looks incomplete or your browser blocked it, click the link below to fetch it again (it stays on the server for ~2 hours). Then import it on the new site.', 'ekwa-wsei' ),
					'doneBatch'         => __( 'Done — %d batch(es) built and downloaded. If any download looks incomplete, click its link below to fetch it again (files stay for ~2 hours), then import them all on the new site.', 'ekwa-wsei' ),
					'failedSingle'      => __( 'Export failed: %s', 'ekwa-wsei' ),
					'failedBatch'       => __( 'Batch %1$d failed: %2$s', 'ekwa-wsei' ),
					'labelSingle'       => __( 'Export ZIP — %1$d stories, %2$d assets', 'ekwa-wsei' ),
					'labelBatch'        => __( 'Batch %1$d — %2$d stories, %3$d assets', 'ekwa-wsei' ),
					'download'          => __( 'Download', 'ekwa-wsei' ),
					'noneChosen'        => __( 'Please select at least one story to export.', 'ekwa-wsei' ),
					'downloadAgain'     => __( 'Download again', 'ekwa-wsei' ),
					'downloadAllBatches' => __( 'Re-download all batches', 'ekwa-wsei' ),
				),
			)
		);
	}
